...
public class LTPUpperThreadGray implements Runnable {
	...
	LTPUpperThreadGray(String fromPath, String toPath, String nomFichier, int seuil) {
	...
	public void run() {
		...
		// write image
		try {
			File file = new File(toPath + "\\UPPER_" + nomFichier);
